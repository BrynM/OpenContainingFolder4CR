...
class Ocf4crSettings:
	...
	def loadSettingsFromFile(self):
		...
		loadSettingsFileExists = self.loadSettingsFileExists()

		if not loadSettingsFileExists:
			self.ocf4cr.dbg("Saving fresh settings file")
			self.saveSettingsFile()
			return

		settingsFileContents = list(File.ReadAllLines(self.settingsPath))

		for idx, aLine in enumerate(settingsFileContents):
	...
	def loadSettingsFileExists(self):
